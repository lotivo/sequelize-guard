...
module.exports = (guard) => {
  ...
  /**
   * Get list of permitted fields to the user by resource.
   *
    @example

    user.permitedFields('blog');

   * @param  {string} resource - Resource to get fields
   *
   * @returns {Array} - list of fields
   */
    GuardUser.prototype.permittedFields = function (resource) {
      return guard.permittedResourceFields(this, resource);
    };
};
