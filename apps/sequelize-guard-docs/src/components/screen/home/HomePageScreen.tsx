  ...
  <nav className="border-b border-slate-200 bg-white/80 backdrop-blur sticky top-0 z-50">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
      <div className="flex items-center gap-3">
        ...
        <span className="text-2xl font-bold text-slate-900">Sequelize Guard</span>
      </div>
...
const FooterSection = () => (
  <footer className="bg-slate-900 text-white py-16">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
      ...
      <div className="flex flex-wrap justify-center gap-4 sm:gap-8 text-slate-400 text-sm sm:text-base">
        <a
          href="https://github.com/lotivo/sequelize-guard"
